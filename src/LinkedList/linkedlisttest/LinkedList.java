...
public class LinkedList implements Collection {
    ...
    public boolean add(Object object) {
        Node last = getLast();
        Node addedNode = new Node(object,null);
        if(last == null){
            first = addedNode;
        } else {
    ...
    private Node findPreviousNode(Node nodeToRemove) {
        if(first.equals(nodeToRemove))return null;
    ...
    private Node findFirstNode(Object object) {
        Node currentNode = first;
        if(currentNode == null){return  null;}
        while(currentNode != null && !currentNode.getData().equals(object) ){
            currentNode = currentNode.getNext();
        }
        return currentNode;
    }
